...
\lstinputlisting[linerange={154-197}, firstnumber=154]{assignment4.cpp}
...
\lstinputlisting[linerange={61-85}, firstnumber=61]{assignment4.cpp}
...
\lstinputlisting[linerange={53-59}, firstnumber=53]{assignment4.cpp}
\hrule
\vspace{.25cm}
...
\lstinputlisting[linerange={102-113}, firstnumber=102]{assignment4.cpp}
\lstinputlisting[linerange={90-100}, firstnumber=90]{assignment4.cpp}
...
\lstinputlisting[linerange={118-151}, firstnumber=118]{assignment4.cpp}
...
\lstinputlisting[linerange={199-204}, firstnumber=199]{assignment4.cpp}
\lstinputlisting[linerange={264-305}, firstnumber=264]{assignment4.cpp}
...
\lstinputlisting[linerange={214-230}, firstnumber=214]{assignment4.cpp}
\newpage
...
\end{enumerate}
\lstinputlisting[linerange={232-262}, firstnumber=232]{assignment4.cpp}
